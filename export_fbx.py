import os
import pyfbsdk
from pyfbsdk import FBApplication, FBSystem, FBModel, FBModelList, FBGetSelectedModels, FBFindModelByLabelName, FBFbxOptions
...
data_path = 'F:/OpenHuman/zeroeggs-retarget/data'
out_path = 'F:/OpenHuman/zeroeggs-retarget/fbx'
...
for file in bvh_files:
    ...
    # FBApplication().FileOpen('F:/OpenHuman/zeroeggs-retarget/LaForgeFemale.fbx')
    FBApplication().FileOpen('F:/OpenHuman/zeroeggs-retarget/LaForgeMale.fbx')
    ...
    FBFindModelByLabelName('LaForge_Model_Male_v020').Selected = True
